...
class PrivateViewController: UIViewController,JSQMessagesViewController {
    
    var roomName = String()
    var fromDBAdress = String()
    ...
    final func didSwipe(sender: UISwipeGestureRecognizer) {
        ...
        override func didPressSend(_ button: UIButton!, withMessageText text: String!, senderId: String!, senderDisplayName: String!, date: Date!) {
            ...
            let rootRef = FIRDatabase.database().reference(fromURL: "https://gokinjyosns.firebaseio.com/").child("message").child(fromDBAddress).child(roomName)
        ...
        func getInfo(){
            ...
            let firebase = FIRDatabase.database().reference(fromURL: "https://gokinjyosns.firebaseio.com/").child("message").child(fromDBAddress).child(roomName)
